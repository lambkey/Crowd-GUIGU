...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    public List<String> getAssignedAuthNameofAuthFromRoleFromAdminByAdminId(Integer adminId) {
        return authMapper.getAssignedAuthNameofAuthFromRoleFromAdminByAdminId(adminId);
    }
}
