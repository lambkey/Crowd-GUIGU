...
public class CrowdExceptionResolver {
    ...
    public ModelAndView resolveLoginFailException(LoginFailedException exception, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        commonUtils(exception,request,response);
    ...
    // 公共方法
    public void commonUtils (Exception exception,HttpServletRequest request,HttpServletResponse response) throws IOException {
        //1、判断当前请求的类型
