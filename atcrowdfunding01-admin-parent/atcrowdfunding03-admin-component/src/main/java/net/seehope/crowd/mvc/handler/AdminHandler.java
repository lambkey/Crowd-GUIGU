...
public class AdminHandler {
    ...
    // SpringSecurity DelegatingFilterProxy拦截 自定义用户无权访问资源跳转的页面
    @RequestMapping(value = "/noAuth/to/error/page.html")
    public String doTrans(ModelMap modelMap){

        modelMap.addAttribute(CrowdConstant.ATTR_NAME_EXCEPTION,new Exception("没有权限权访问"));
    ...
    // 管理员用户单点删除
    // @PreAuthorize想要生效要在security配置类上面配置
    @PreAuthorize("hasRole('OPR-项目经理')")
